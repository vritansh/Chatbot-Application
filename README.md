** Whatsapp Bot is a simple bot which provides you with random quotes when you text it. ** Please do the following to register yourself as authenticated user:
